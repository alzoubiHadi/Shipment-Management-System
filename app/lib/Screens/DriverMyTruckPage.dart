  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('My Truck', style: TextStyle(color: AppColors.cream)),
      ),
        ...
        child: FutureBuilder<List<Truck>>(
          ...
          builder: (context, snapshot) {
            ...
            if (snapshot.hasError) {
              return const Center(child: Text('Could not load your truck', style: TextStyle(color: AppColors.error)));
            }
            ...
            if (trucks.isEmpty) {
              return ListView(
                ...
                children: [
                  ...
                  const Icon(Icons.local_shipping_outlined, color: AppColors.muted, size: 48),
                  const SizedBox(height: 16),
                  const Text('No truck registered yet', textAlign: TextAlign.center, style: TextStyle(color: AppColors.cream, fontSize: 16, fontWeight: FontWeight.w600)),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: const Text('Add Truck', style: TextStyle(color: AppColors.bg, fontWeight: FontWeight.w700)),
                    ),
                  ),
                ],
              );
        ...
        children: [
          Row(
            children: [
              Container(
                ...
                child: const Icon(Icons.local_shipping_rounded, color: AppColors.gold, size: 24),
              ),
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(truck.truckNumber, style: const TextStyle(color: AppColors.cream, fontSize: 17, fontWeight: FontWeight.w700)),
                    const SizedBox(height: 2),
                    Text(truck.truckType, style: const TextStyle(color: AppColors.muted, fontSize: 12.5)),
                  ],
                ),
              ),
              Container(
                ...
                decoration: BoxDecoration(
                  color: (truck.isActive ? AppColors.success : AppColors.muted).withOpacity(0.12),
                  borderRadius: BorderRadius.circular(8),
                ),
                child: Text(truck.isActive ? 'Active' : 'Inactive',
                    style: TextStyle(color: truck.isActive ? AppColors.success : AppColors.muted, fontSize: 10.5, fontWeight: FontWeight.w700)),
              ),
            ],
          ),
          ...
          SizedBox(
            ...
            child: OutlinedButton(
              ...
              child: const Text('View Documents', style: TextStyle(color: AppColors.cream, fontWeight: FontWeight.w600)),
            ),
          ),
        ],
      ),
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          Text(value, style: const TextStyle(color: AppColors.cream, fontSize: 12.5, fontWeight: FontWeight.w600)),
        ],
      ),
    );
  }
      ...
      children: [
        Expanded(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(label, style: const TextStyle(color: AppColors.cream, fontSize: 13, fontWeight: FontWeight.w600)),
