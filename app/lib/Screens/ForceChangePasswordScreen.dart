...
///
/// Admin Phase 6 (2026-08-20) redesign to LightColors — reachable by any
/// role forced to change a temporary password (sub-admin, company).
  ...
  Widget _field(TextEditingController ctrl, String label) {
    return TextField(
      ...
      decoration: InputDecoration(
        labelText: label,
        labelStyle: const TextStyle(color: LightColors.textSecondary, fontSize: 13),
        filled: true,
